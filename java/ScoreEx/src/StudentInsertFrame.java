...
public class StudentInsertFrame extends JFrame{
	...
	public void insertStudent() {
		...
		String classyear1 = txtName.getText();
		String email = txtEmail.getText();
		
		if(id1.isBlank() || pw1.isBlank() || name1.isBlank() || classyear1.isBlank() || email.isBlank()) {
		...
		try {
			...
			if (result == 1) {
				JOptionPane.showMessageDialog(frame, "회원등록이 완료되었습니다.");
			}else {
